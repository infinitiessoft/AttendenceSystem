angular
		.module(
				'attendance',
				[ 'ngRoute', 'ngCookies', 'formly', 'formlyBootstrap',
						'ui.bootstrap', 'smart-table', 'auth', 'navigation',
						'list-employees', 'edit-employee', 'edit-profile',
						'list-departments', 'edit-department', 'list-roles',
						'edit-role', 'list-recordtypes', 'edit-recordtype',
						'list-records', 'edit-record', 'list-leavesettings',
						'edit-leavesetting', 'list-employeeleaves',
						'edit-employeeleave', 'list-events',
						'list-memberrecords', 'edit-memberrecord',
						'list-memberevents' ])
		.config(
				[
						'$routeProvider',
						...
						function($routeProvider, $state, $httpProvider,
								formlyConfigProvider) {
							...
							$routeProvider.when('/edit-department/:id', {
								templateUrl : 'partials/edit.html',
								controller : 'edit-department',
								resolve : {
									department : function(departmentService,
											$route) {
										var id = $route.current.params.id;
										if (id == 0) {
											return {
							...
							$routeProvider.when('/edit-role/:id', {
								templateUrl : 'partials/edit.html',
								controller : 'edit-role',
								resolve : {
									role : function(roleService, $route) {
										var id = $route.current.params.id;
										if (id == 0) {
											return {
												data : {}
							...
							$routeProvider.when('/edit-recordtype/:id', {
								templateUrl : 'partials/edit.html',
								controller : 'edit-recordtype',
								resolve : {
									recordtype : function(recordtypeService,
											$route) {
										var id = $route.current.params.id;
										if (id == 0) {
											return {
							...
							$routeProvider.when('/edit-leavesetting/:id', {
								templateUrl : 'partials/edit.html',
								controller : 'edit-leavesetting',
								resolve : {
									leavesetting : function(
											leavesettingService, $route) {
										var id = $route.current.params.id;
										if (id == 0) {
											return {
												data : {}
							...
							$routeProvider.when('/edit-employeeleave/:id', {
								templateUrl : 'partials/edit.html',
								controller : 'edit-employeeleave',
								resolve : {
									employeeleave : function(
											employeeleaveService, $route) {
										var id = $route.current.params.id;
										if (id == 0) {
											return {
												data : {}
							...
							$routeProvider.when('/edit-record/:id', {
								templateUrl : 'partials/edit.html',
								controller : 'edit-record',
								resolve : {
									record : function(recordService, $route) {
										var id = $route.current.params.id;
										if (id == 0) {
											return {
												data : {}
							...
							$routeProvider.when('/edit-memberrecord/:id', {
								templateUrl : 'partials/edit.html',
								controller : 'edit-memberrecord',
								resolve : {
									record : function(memberRecordService, $route) {
										var id = $route.current.params.id;
										console.debug('id:'+id);
										if (id == 0) {
											return {
		...
		.run(
				function($rootScope, $location, $cookieStore, $http,
						formlyConfig, auth, formlyConfig,
					...
					var attributes = [ 'date-disabled', 'custom-class',
							...
							'readonly-input', 'mousewheel', 'arrowkeys' ];

					var bindings = [ 'datepicker-mode', 'min-date', 'max-date',
							'hour-step', 'minute-step', 'show-meridian' ];
