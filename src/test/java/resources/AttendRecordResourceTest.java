...
public class AttendRecordResourceTest extends ResourceTest {
	...
	public void testSaveAttendRecord() throws ParseException {
		...
		record.setStartDate(DateFormat.getDateTimeInstance().parse(
				"2016/05/05 上午 10:00:00"));
		record.setEndDate(DateFormat.getDateTimeInstance().parse(
				"2016/05/06 下午 06:00:00"));
		...
		Authentication auth = new UsernamePasswordAuthenticationToken("pohsun",
				"pohsun");
