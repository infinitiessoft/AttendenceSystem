...
//		attendrecord.setModify_end_date(new Date());
//		attendrecord.setModify_start_date(new Date());
//		attendrecord.setModify_date(new Date());
//		attendrecord.setEmployee_id("1");
//		attendrecord.setPermit("demo");
//		attendrecord.setReason("demo");
//		attendrecord.setDuration(new Date());
//		attendrecord.setEnd_date(new Date());
//		attendrecord.setBook_date(new Date());
//		attendrecord.setPermic_person_id("1");
//		attendrecord.setStart_date(new Date());
...
//		attendrecord.setPermic_person_id2(1L);
//
//	}
//
//	@After
...
//							throws Throwable {
//						AttendRecord e = (AttendRecord) invocation
//								.getParameter(0);
//						e.setId(2L);
//						return e;
//					}
